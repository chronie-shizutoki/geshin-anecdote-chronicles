...
const characterData = [
    ...
    { id: 75, character: "夏洛蒂 (1)", version: "5.7", travelName: "①耐心", location: "枫丹-枫丹廷", hiddenCondition: "", extraCharacter: "", description: "夏洛蒂小姐最终还是没有等来她的「采访对象」。但在她的采访簿上，并不存在「气馁」这个词。很快，她就要奔向下一个地点了...", isHidden: false },
    { id: 76, character: "夏洛蒂 (2)", version: "5.7", travelName: "②糟糕糟糕", location: "枫丹-枫丹廷", hiddenCondition: "", extraCharacter: "", description: "再完美的计划，也总是会因为一点小疏忽而被破坏。夏洛蒂想要前往纳塔的企图被主编看穿，并被阻拦了下来。但是，她很快找到了下一个目的地——挪德卡莱。", isHidden: false },
    { id: 77, character: "夏洛蒂 (3)", version: "5.7", travelName: "③新目的地", location: "枫丹-枫丹廷", hiddenCondition: "", extraCharacter: "千织", description: "说服了父母后，夏洛蒂终于获得了前往挪德卡莱的机会。或许在那片土地上，她会发现更多「有趣的故事」。", isHidden: false },
